...
import com.fernandocejas.sample.features.movies.movieslist.MoviesAdapter.ViewHolder
import kotlinx.android.synthetic.main.row_movie.view.*
import javax.inject.Inject
import kotlin.properties.Delegates

class MoviesAdapter
@Inject constructor() : RecyclerView.Adapter<ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
      ViewHolder(
          parent.inflate(layout.row_movie)
      )
